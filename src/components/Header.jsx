...
const Header = () => {
    ...
    >
        ...
        >Unleash your creativity with AI. Turn your imagination into visual art in seconds - just type, ans watch the magic happen.</motion.p>
        <motion.button 
            ...
            onClick={onClickHandler} className='inline-flex iteams-center gap-2 px-12 py-3 rounded-full bg-black text-white w-auto mt-8 px-12 py-2.5 hover:scale-[1.05] transition-all duration-500'
        >
            Generate Images 
